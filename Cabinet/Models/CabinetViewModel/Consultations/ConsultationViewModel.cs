using Cabinet.Models.CabinetViewModel.Consultations.Examinations;
using System;
...
namespace Cabinet.Models.CabinetViewModel.Consultations
{
    public class ConsultationViewModel
    {
        ...
        public MensurationViewModel Mensuration { get; set; }
        public ExaminationViewModel Examination { get; set; }
        public string Biologique { get; set; }
        public string Radiologique { get; set; }
        public string Diagnostic { get; set; }
        public TherapieViewModel Therapie { get; set; }
        public string Synthèse { get; set; }
        public DateTime? NextRDV { get; set; }
